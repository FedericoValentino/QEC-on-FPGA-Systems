...
#pragma HLS STREAM variable=syn_stream depth=192
	hls::stream<uint32_t> syn_vert_stream("syn_vert_stream");
#pragma HLS STREAM variable=syn_vert_stream depth=192
	hls::stream<Edge> fuseList("fuseList");
#pragma HLS STREAM variable=fuseList depth=384
	hls::stream<Edge> peeling_edges("peeling_edges");
#pragma HLS STREAM variable=peeling_edges depth=384
	hls::stream<Edge> correction_edges("correction_edges");
#pragma HLS STREAM variable=correction_edges depth=384
